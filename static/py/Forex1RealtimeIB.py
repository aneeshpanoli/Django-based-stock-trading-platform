...
subject to the terms and conditions of the IB API Non-Commercial License or the
 ...
 # use self.INSTRUMENT variable in the Beginning to assign stocks/forex etc
"""
...
# self.INSTRUMENT = ContractSamples.USStockAtSmart()
...
class TestApp(TestWrapper, TestClient):
    ...
    def __init__(self, tickrSymbol):
        ...
        self.tickr = self.INSTRUMENT.symbol # my addition
...
if __name__ == "__main__":
    # tickrSymbol = input("Please enter stock tickr: ")
